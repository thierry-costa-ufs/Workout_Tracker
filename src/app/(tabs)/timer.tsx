...
// Tipagem estrita para os glifos aceitos do Ionicons
...
export default function TimerScreen() {
  ...
  // Uso correto do NodeJS.Timeout | number para compatibilidade cross-platform
...
const styles = StyleSheet.create({
  ...
  progressBar: { height: "100%", backgroundColor: "#E5E5EA", borderRadius: 2 },
  adjustmentContainer: {
    flexDirection: "row",
  ...
  controlCirclePause: { backgroundColor: "#E5E5EA" },
  presetsSection: {
    flex: 1,
  ...
  presetCardActive: { borderColor: "#FFF", backgroundColor: "#1C1C1E" },
