...
export default function TabTwoScreen() {
  ...
  const handleUpdateSets = (index: number, newSets: number) => {
    ...
    setDraftWorkout((prev) => {
      ...
      const updatedList = currentDayList.map((ex, i) =>
          ...
          <View style={styles.workoutList}>
            ...
            draftWorkout[selectedDay].length === 0 ? (
              ...
              draftWorkout[selectedDay].map((ex, index) => {
                const mainListPR = getExercisePR(ex.id);
                return (
                      ...
                      >
                        ...
                        {mainListPR && (
                          <View style={styles.mainListPrBadge}>
                            <Ionicons name="trophy" size={9} color="#FF9F0A" />
...
interface ExerciseCardItemProps {
  ...
  pr: PersonalRecord | undefined; // <- Corrigido aqui
  onAdd: () => void;
}

function ExerciseCardItem({ item, pr, onAdd }: ExerciseCardItemProps) {
      ...
      <View style={{ flex: 1, marginRight: 10 }}>
        ...
        <View style={styles.metaBadgeContainer}>
          <View
            style={[
              styles.metaBadge,
              isComposto ? styles.badgeComposto : styles.badgeIsolado,
            ]}
          >
            <Text
              style={[
                styles.metaBadgeText,
                { color: isComposto ? "#FF9F0A" : "#8E8E93" },
              ]}
            >
...
// Estilos mantidos integralmente conforme os seus originais
const styles = StyleSheet.create({
  ...
  prText: { color: "#FF9F0A", fontSize: 10, fontWeight: "900" },
  mainListPrBadge: {
    flexDirection: "row",
    alignItems: "center",
  ...
  mainListPrText: { color: "#FF9F0A", fontSize: 9, fontWeight: "700" },
});
