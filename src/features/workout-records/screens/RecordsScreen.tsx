    ...
    >
      ...
      {personalRecords.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={[sharedScreenStyles.cardSurface, styles.prCard]}>
      ...
      <Modal transparent visible={modalVisible} animationType="slide">
        <View style={sharedScreenStyles.modalOverlay}>
          <View style={[sharedScreenStyles.modalSheet, styles.modalView]}>
